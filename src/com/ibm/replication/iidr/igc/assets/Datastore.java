...
public class Datastore {
	...
	public String toAssetXML() {
		return MessageFormat.format(
				...
				new Object[] { this.name, this.id, this.name, this.description, this.description, this.host, this.port,
						this.version, this.platform, this.engine_type, this.type, IGC_CLASS_NAME });
	}
