...
public class Subscription {
	...
	public Subscription(String id, String name, String description, String source_datastore, String target_datastore, String source_id, 
						String tcp_host, String firewall_port, String persistency, String parent_id) {
		this.id = id;
		this.name = name;
	...
	public String toAssetXML() {
		return MessageFormat.format("\t\t<asset class=\"{12}\" repr=\"{0}\" ID=\"{1}\">\n" +
			...
			"\t\t</asset>\n", 
       		 new Object[] {this.name, this.id, this.name, this.description, this.description, this.source_datastore,
       				 		this.target_datastore, this.source_id, this.tcp_host, this.firewall_port, 
       				 		this.persistency, this.parent_id, IGC_CLASS_NAME});
	}
	...
	public static void main(String[] args) {
		...
		Subscription sub = new Subscription("sub1", "BLA", "Replicating customer data", "ORCL", "TESTDB", "BLA", "Auto Select", "", "No", "ds1");
